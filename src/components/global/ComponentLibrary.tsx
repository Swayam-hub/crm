      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-full max-w-[350px] bg-[#0c0c0e] border-l border-white/10 z-[200] shadow-2xl flex flex-col"
          >
            {/* Header */}
            ...
            <div className="p-4">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-white/[0.03] border border-white/5 rounded-xl py-2 pl-9 pr-4 text-xs text-white placeholder:text-zinc-600 focus:outline-none focus:border-indigo-500/50 transition-colors"
                />
              </div>
            </div>
                  ...
                  <div className="space-y-1">
                    {group.items.map((item) => (
                      <motion.div
                        key={item.name}
                        whileHover={{ x: 4 }}
                        className="group flex items-center gap-4 p-3 rounded-xl hover:bg-white/[0.03] cursor-pointer transition-colors border border-transparent hover:border-white/5"
                      >
